...
2.  Before installing, run `usethis::edit_r_environ()`
...
3.  Once you have your login credentials saved in your .Renviron, install the [latest BacDiveR release][releases]
